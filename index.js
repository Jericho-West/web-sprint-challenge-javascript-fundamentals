...
function add(callIt, andAgain) {
    return callIt + andAgain
  }


// 🦁🦁🦁 Use multiply to return the product of two numbers 🦁🦁🦁
  
function multiply(callIt, andAgain){
   return callIt * andAgain
  }
...
function greeting(callIt, andAgain){
  return `Hello ${callIt} ${andAgain}, nice to meet you!`
  }
...
*/
function CuboidMaker(pancake){
  this.length = pancake.length,
  this.width = pancake.width,
  this.height = pancake.height
}
